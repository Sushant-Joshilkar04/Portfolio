...
const profile = {
    ...
    title: 'Full-Stack Developer | Problem Solver | Cloud Enthusiast ',
    skills: [
        'React', 'NextJS', 'Redux', 'Express','JavaScript', 'HTML', 'CSS',
        'Java','Bootstrap', 'Tailwind CSS', 'RESTful APIs',
        'MySQL', 'MongoDB', 'Docker', 'Firebase', 'TypeScript',
        'GraphQL', 'Git', 'Linux', 'Tailwind CSS', 'Node.js',
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
  ...
  return (
    <>
      <main className="bg-[#020617] text-white min-h-screen">
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Sushant-Joshilkar04"
                ...
                {/*Resume Button*/}
                <a
                  href="https://drive.google.com/file/d/1e8eqlrvh8DTn52tnUSCURa09yxOjsw0A/view?usp=sharing"
        ...
        <div className="w-full flex flex-col items-center mt-24 mb-12">
          <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-teal-400 to-purple-500 drop-shadow-lg tracking-tight mb-4">
            My Projects
          </h2>
          <p className="text-lg md:text-xl text-zinc-300/80 font-medium max-w-2xl text-center">
            Explore some of the work I&apos;ve built, designed, and shipped recently.
          </p>
          <div className="w-24 h-1 mt-4 rounded-full bg-gradient-to-r from-blue-400 via-teal-400 to-purple-500 opacity-70" />
        </div>
