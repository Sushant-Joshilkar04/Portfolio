...
import { BsEmojiExpressionless, BsEmojiExpressionlessFill, BsFileEarmarkCode, BsGrid1X2 } from "react-icons/bs";
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "IntelliJ IDEA",
          icon: <span className="w-4 h-4 text-[#000000]">IDE</span>,
        }
      ],
    },
      // {
